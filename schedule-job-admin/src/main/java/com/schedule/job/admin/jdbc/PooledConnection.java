...
public class PooledConnection implements Connection {
    ...
    public PooledConnection(Connection realConnection, boolean isQuartzConnection) {
        ...
        this.isQuartzConnection = isQuartzConnection;
    }
    ...
    public void close() throws SQLException {
        ...
        isClosed = true;
        // 归还到连接池而不是真正关闭
        if (isQuartzConnection) {
            QuartzJdbcClient.releaseConnection(realConnection);
        } else {
            JdbcClient.releaseConnection(realConnection);
        }
    }
